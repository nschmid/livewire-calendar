...
![preview](https://github.com/nschmid/livewire-calendar/raw/master/preview.gif)
...
```bash
composer require nschmid/livewire-calendar
```
...
![example](https://github.com/nschmid/livewire-calendar/raw/master/example.png)
